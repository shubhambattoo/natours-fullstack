    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(_axios.default.get("/api/v1/users/logout"));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(_axios.default.patch("/api/v1/users/updateMe", {
            name: name,
            email: email
          }));
  ...
  return regeneratorRuntime.async(function updateSettings$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          uri = type === "data" ? "/api/v1/users/updateMe" : "/api/v1/users/updateMyPassword";
          _context2.next = 4;
