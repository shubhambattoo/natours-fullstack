      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "User logged in!!");
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(_axios.default.get("http://localhost:3000/api/v1/users/logout"));
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "some error occured");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoic2h1YmhhbWJhdHRvbyIsImEiOiJjazMyejZrcXgwbmRqM2RtamUybnRrdnlrIn0.pJs-IejTV9RU03ccae8wEA";
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p> Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend the maps bounds to include the current location
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(_axios.default.patch("http://localhost:3000/api/v1/users/updateMe", {
            name: name,
            email: email
          }));
...
var updateSettings = function updateSettings(data, type) {
  var uri, res;
  return regeneratorRuntime.async(function updateSettings$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          uri = type === "data" ? "http://localhost:3000/api/v1/users/updateMe" : "http://localhost:3000/api/v1/users/updateMyPassword";
          _context2.next = 4;
          return regeneratorRuntime.awrap(_axios.default.patch(uri, data));
        ...
        case 8:
          ...
          _context2.t0 = _context2["catch"](0);
          console.log(_context2.t0);
          (0, _alerts.showAlert)("error", _context2.t0.response.message);
...
/* eslint-disable */
var stripe = Stripe("pk_test_51IZVzfSBv7sGF9AzZgONXpbzRIdOPNVZggOaxZSf9X3cnGDJE743TpcIhDH5hoFdMIYzb2BUHZGzN5HPdv7HDEhr00Quzt8ehe");
...
var userPasswordForm = document.querySelector("#pasword-form");
...
if (userPasswordForm) {
  userPasswordForm.addEventListener("submit", function _callee(e) {
    var passworCurrent, password, passworConfirm;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            passworCurrent = document.getElementById("password-current").value;
            password = document.getElementById("password").value;
            passworConfirm = document.getElementById("password-confirm").value;
            _context.next = 6;
            return regeneratorRuntime.awrap((0, _updateSettings.updateSettings)({
              password: password,
              passworCurrent: passworCurrent,
              passworConfirm: passworConfirm
            }, "data"));
